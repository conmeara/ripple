...
# Sync desktop app to a public Ripple repository
...
PUBLIC_REPO="git@github.com:conmeara/ripple.git"
PUBLIC_REPO_HTTPS="https://github.com/conmeara/ripple"
PRIVATE_REPO="conmeara/ripple"
TEMP_DIR="/tmp/ripple-sync-$$"
...
if [ -z "$RELEASE_NOTES" ]; then
    ...
    echo "   gh release create $TAG --title \"Ripple $TAG\" --notes \"...\""
    echo ""
