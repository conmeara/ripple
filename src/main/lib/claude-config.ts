 ...
 * Supports hidden Ripple worktrees at ~/.ripple/worktrees/{projectName}/{worktreeFolder}/.
 *
...
export function resolveProjectPathFromWorktree(
  ...
  const worktreeMarker = path.join(".ripple", "worktrees")
  ...
  try {
    ...
    // Path format: /Users/.../.ripple/worktrees/{projectSlug}/{worktreeFolder}
    const worktreeBase = path.join(os.homedir(), ".ripple", "worktrees")
